...
#     for j in range(dp_index):
#         count += 1
#         overlap_cmd = "python3 nonoverlapping-community-detection.py --lr {lr} --dropout {dropout}".format(lr = lrs[i], dropout = dropouts[j])
#         overlap_call_list = overlap_cmd.split(" ")
#         call(overlap_call_list)
